...
import CommentForm from "./CommentsForm";  // Corrected the import for CommentForm
      ...
      <section className="post-section">
        <div className="post">
          ...
          <div className="post-wrapper">
            ...
            <RecipeList userId={user?._id} deleteRecipe={deleteRecipe} />
          </div>
        </div>
      </section>
    </div>
